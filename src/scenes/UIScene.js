export class UIScene {
    ...
    elStartMenu;
    elSettingsMenu;
    hudWrapper; // the main hud that should be hidden during menu
    constructor(emitter) {
    ...
    setupMenuListeners() {
        // Start Menu
        const btnStart = this.elStartMenu.querySelector('#btn-start');
        const btnSettings = this.elStartMenu.querySelector('#btn-settings');
        ...
        // Settings Menu
        const btnBack = this.elSettingsMenu.querySelector('#btn-settings-back');
    ...
    subscribeToEvents() {
        ...
        this.emitter.on('ui:countdown', (seconds) => {
    ...
    showCountdownOverlay(hideTimer = true) {
        ...
        clearTimeout(this.elCountdown._hideTimeout);
        this.elCountdown._hideTimeout = setTimeout(() => {
            this.hideCountdownOverlay();
        }, 850);
    }
